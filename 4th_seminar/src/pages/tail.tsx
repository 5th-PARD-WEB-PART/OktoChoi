export default function Tail(){
    ...
    <main className ="min-h-screen bg-gray-100 p-6">
        <h1 className="text-3xl font-bold text-center mb-8 text-gray-900">Tailwind 반응형 실습</h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {[1,2,3,4,5,].map((_, index) => ( //map에 _ value가 들어가야할자리에 _이거 넣었어요!! _는 그 값을 안쓸거에요 이미 정해놨으니까
            <div
            key={index}
            className="
